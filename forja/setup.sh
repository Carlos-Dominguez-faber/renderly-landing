...
echo "  c \"\$(cat $REPO_DIR/forja/prompts/sandbox-1-literal.md)\""
echo ""
echo "Tab 2 (Creativo):"
echo "  cd $REPO_DIR/../sandbox-2"
echo "  c \"\$(cat $REPO_DIR/forja/prompts/sandbox-2-creativo.md)\""
echo ""
echo "Tab 3 (Disruptivo):"
echo "  cd $REPO_DIR/../sandbox-3"
echo "  c \"\$(cat $REPO_DIR/forja/prompts/sandbox-3-disruptivo.md)\""
echo ""
echo "Review (cuando terminen):"
echo "  cd $REPO_DIR"
echo "  Usa forja/prompts/review-prompt.md"
echo ""
echo "═══════════════════════════════════════════════════════"
