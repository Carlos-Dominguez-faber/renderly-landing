...
export function CtaFinalSection({ videoLabel }: CtaFinalProps) {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-6">
        ...
        {/* Video placeholder (non-interactive) */}
        <motion.div
        ...
        >
          ...
          <div className="relative overflow-hidden rounded-2xl border border-white/[0.08] shadow-2xl shadow-black/40">
            ...
            {/* Static play overlay — not clickable */}
            <div className="absolute inset-0 flex items-center justify-center bg-black/30">
              <div className="absolute h-24 w-24 animate-pulse rounded-full bg-cta/10" />
              <div className="relative z-10 flex items-center gap-3 rounded-full border border-white/20 bg-white/10 px-6 py-3 backdrop-blur-md">
