    ...
    >
      ...
      <div className="relative mt-6">
        <div className="mb-2 flex justify-between">
          ...
          <span className="font-body text-xs text-white/50">{includedCount}/{totalFeatures}</span>
        </div>
...
export function NewPricingSection({ badge: badgeText, title, subtitle, plans }: NewPricingSectionProps) {
